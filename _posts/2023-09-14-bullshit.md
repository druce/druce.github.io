...
Science is hard. People were awarded Nobel prizes for the lobotomy, and for DDT. People were awarded the prize for contradictory findings (Fama and Shiller, Hayek and Myrdal). Top mathematicians like Gödel published proofs that were accepted for a long time and then found incorrect. There was a mathematician who published a proof in a top journal, a few years later it was found incorrect, and he published another paper in the same top journal proving the opposite of the first paper. If a top scientist publishes a proof and I give a counter-example, is that considered 'calling bullshit?'
