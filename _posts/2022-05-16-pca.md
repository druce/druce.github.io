...
If we multiply our left singular vectors by the singular values, we get our principal components. In this example we have our random unrotated data back. The PCA rotation unscrambles or unf\*\*ks the basis, whether it's in 2 or higher dimensions.
