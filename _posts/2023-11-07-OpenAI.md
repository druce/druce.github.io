...
As an aside, I wrote this mostly in Obsidian in Markdown. Obsidian is a good note-taking app, kind of like Notion or Evernote. It also has a nice OpenAI plug-in which lets you use ChatGPT with custom prompts to summarize, copy edit etc. You can also point to other LLMs and even a local Llama instance.
