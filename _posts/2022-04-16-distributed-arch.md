...
The hope is that if you create a devops standard, either the cloud platforms will support it, or you can stand up independent platforms than run on top of the cloud platforms and expose the APIs and provide the SLA guarantees. Cloud platforms might feel they want differentiation and lock-in. But if a large market develops a standard really should develop for the basics. Basic devops is too hard, I should be able to just 'vagrant up' a container on any cloud without going through 9 steps.
