...
| -------------- | ----------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | 
| **Foundation Layer** |
| **Identity & Access**                         | **Microsoft Entra ID**, Okta, Ping Identity, CyberArk, ForgeRock       | Every human *and* agent has a real identity, SSO, and RBAC. The bouncer at the door — verifies who (or which agent) you are and hands out least-privilege badges. | **Required — Day 1**                               |
