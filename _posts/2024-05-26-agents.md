...
Another complex agent flow is the one used by AutoGPT. With AutoGPT you give it a prompt, and a goal, and some tools like the ability to search Google and Wikipedia and other sites, and let it loop until it reaches the goal. 

For instance, suppose you wnat to ask AutoGPT to recommend the best espresso grinders under $500. The flow might go like this:
