...
The MTA has gotten MUCH better. Almost graffiti free, AC on the trains, frequent service, pretty safe and reliable.[^2] And open data that any fool on the Internet can use, and find fault with.
...
We can see in the data that ridership dropped massively and the central business district stations dropped the most. Less clearly, one can glean that silk stocking district stations dropped a little less, maybe people still go out but travel to work less. Traffic at outer stations dropped even less as essential workers still need to work.[^4]
