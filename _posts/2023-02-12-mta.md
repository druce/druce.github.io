...
But the subway might be falling victim to a doom loop. Fewer riders make it less safe and service less frequent, driving more riders away, perpetuating the cycle. The system has huge debt and interest rates have gone up a lot. So then the system has to raise fares, triggering another down cycle.
