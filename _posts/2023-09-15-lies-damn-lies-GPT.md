...
There can be a 'brittleness' to AI solutions. The Adversarial in 'Generative Adversarial Networks' means you are training an AI to make images another AI can't detect as fakes. And yet a simple finger count or dental inspection defeats it. Similarly, a simple bit of trickery helped [a human defeat AlphaGo](https://www.vice.com/en/article/v7v5xb/a-human-amateur-beat-a-top-go-playing-ai-using-a-simple-trick). It feels like a bit of model heterogeneity and diversification might help.
...
We can train LLMs for specialized problem-solving using SQL, or [REST API specs](https://gorilla.cs.berkeley.edu/). 
