...
You are the easiest person to fool, and you are incentivized to privilege sweet, self-serving bullshit over bitter truth.  Feynman used the example of cargo cults in Papua New Guinea natives after World War 2, when natives built fake airfields and control towers hoping to bring back American planes and 'cargo'. He used cargo cults to represent pseudo-scientific bullshit.
