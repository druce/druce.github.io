...
Suppose labs all used electronic notebooks with a cryptographically secure permanent audit trail? It would be a lot harder to alter data and photoshop X-rays. I'm never going to say 'blockchain solves this' because [blockchain solves nothing](2022/03/distributed-architecture). At the end of the day you still have to trust people, or you don't have a society and a culture. But using cryptographic assurance to establish provenance can make information more trustworthy.
