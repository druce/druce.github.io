...
The solution $$y_t = a_1 \lambda_1^t + a_2 \lambda_2^t$$ with complex $$a$$s and $$\lambda$$s is not *wrong*. But it would be *nice* to just find the solution with a cosine function and period, amplitude and phase.
