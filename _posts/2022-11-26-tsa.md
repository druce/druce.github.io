...
- Asymptotically, the largest root (eigenvalue) will dominate. If it is larger than 1 in absolute value (modulus if complex) our time series diverges. If it is less than 1 in absolute value (modulus) our time series goes to 0.
