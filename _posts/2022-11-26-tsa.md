...
- The closed-form expression is $$y_t =  D^t \vec{a}$$, a linear combination of the $$\lambda^t$$s.
...
- We us our initial conditions to solve for the numeric values of $$\vec{a}$$, a linear combination of roots raised to the power of $$t$$.
