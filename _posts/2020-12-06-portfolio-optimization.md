...
[^1]: For a more mathematical explanation, suppose market returns follow a normal distribution and market prices therefore follow a lognormal distribution. Risk means that over your time horizon, say 10 years, the stock could do very well or very poorly. More things can happen than will happen. There is a well-defined mathematical relationship between the 10-year returns and the daily returns. So if you know the daily distribution you can infer the 10-year returns and vice versa. For the normal distribution, it's a square-root-of-time law. And because log transforms multiplication into addition, the same square-root law applies to returns. Note that stock returns do not exactly follow the normal distribution, they have fatter tails, maybe a combination of a normal distribution and a Poisson distribution for rare shocks.
